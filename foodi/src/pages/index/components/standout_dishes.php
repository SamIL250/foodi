        ...
        <div class="grid grid-cols-3 gap-6">
            <div class="shadow-lg shadow-gray-200 py-3 px-10 rounded-[20px] relative border border-gray-200 ">
                ...
                <div class="flex justify-center mb-7">
                    <img src="./src/assets/Fattoush salad.png" class="w-[200px]" alt="">
                </div>
                <div class="mb-3">
                    <p class="font-bold">Fattoush salad</p>
                    <small class="text-gray-400 mt-3">Description of the item</small>
                </div>
                <div class="flex justify-between">
                    <p class="font-bold"><span class="text-[12px] text-red-400">$</span>24.00</p>
